...
@section('content')
    ...
    <div class="panel panel-danger panel-default">
        ...
        <div class="panel-body">
            ...
            <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('karyawan.store') }}">
                {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="image" class="form-control" value="{{ old('foto') }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nokk" class="form-control" required placeholder="357678xxxx" value="{{ old('nokk') }}">
                                </div>
                                <div class="form-group">
                                    <label for="nokk"><span class="red">*</span>NO KTP :</label>
                                    <input type="text" name="noktp" class="form-control" required placeholder="357678xxxx" value="{{ old('noktp') }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nohp" class="form-control" required placeholder="0881xxx" value="{{ old('nohp') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-body panel-info">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_wali" class="form-control" style="text-transform: uppercase;" placeholder="Nama Wali" value="{{ old('nama_wali') }}">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="panel panel-body panel-info">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="dapat_bekerja" style="text-transform: uppercase;" class="form-control" required placeholder="sekarang / secepatnya" value="{{ old('dapat_bekerja') }}">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-body panel-info">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_sekolah" style="text-transform: uppercase;" class="form-control" required placeholder="Nama Asal Sekolah" value="{{ old('nama_sekolah') }}">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-body panel-info">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jenis_pendidikan" class="form-control" placeholder="Kursus / yang lain" style="text-transform: uppercase;" value="{{ old('jenis_pendidikan') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="lembaga">LEMBAGA :</label>
                                        <input type="text" name="lembaga" style="text-transform: uppercase;" class="form-control" placeholder="Nama Lembaga" value="{{ old('lembaga') }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="durasi" class="form-control" style="text-transform: uppercase;" placeholder="6 Bulan" value="{{ old('durasi') }}">
                                    </div>
                            ...
                            <div class="panel">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_perusahaan" class="form-control" placeholder="PT. MAJU MAPAN" style="text-transform: uppercase;" value="{{ old('nama_perusahaan') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="alamat_perusahaan">ALAMAT PERUSAHAAN :</label>
                                        <input type="text" name="alamat_perusahaan" class="form-control" placeholder="Alamat lengkap" style="text-transform: capitalize;" value="{{ old('alamat_perusahaan') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="bidang_usaha">BIDANG USAHA :</label>
                                        <input type="text" name="bidang_usaha" style="text-transform: capitalize;" class="form-control" placeholder="Bidang usaha perusahaan" value="{{ old('bidang_usaha') }}">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="gaji" style="text-transform: uppercase;" class="form-control" placeholder="UMR / UMK / Atau yang lain" value="{{ old('gaji') }}">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" name="mulai_kerja" class="form-control pull-right" id="date" data-toggle="datepicker" placeholder="2014-12-25" value="{{ old('mulai_kerja') }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" name="akhir_kerja" class="form-control pull-right" id="date" data-toggle="datepicker" placeholder="2014-12-25" value="{{ old('akhir_kerja') }}">
                                        </div>
                                    </div>
            ...
            <a href="{{ route('karyawan.index') }}" class="btn btn-success nextBtn pull-right">Censel</a>
        </div>
    </div>
@endsection
