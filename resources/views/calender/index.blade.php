...
<head>
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="{{ asset('assets2/bower_components/fullcalendar/dist/fullcalendar.min.css')}}">
  <link rel="stylesheet" href="{{ asset('assets2/bower_components/fullcalendar/dist/fullcalendar.print.min.css')}}" media="print">
  <!-- Theme style -->
...
<!-- jQuery UI 1.11.4 -->
<script src="{{asset('assets2/bower_components/jquery-ui/jquery-ui.min.js')}}"></script>
<!-- Slimscroll -->
...
<!-- fullCalendar -->
<script src="{{ asset('assets2/bower_components/moment/moment.js')}}"></script>
<script src="{{ asset('assets2/bower_components/fullcalendar/dist/fullcalendar.min.js')}}"></script>
